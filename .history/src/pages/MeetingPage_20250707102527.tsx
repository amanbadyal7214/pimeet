        ...
        <div className="flex-1 flex flex-col rounded-3xl overflow-hidden bg-gray-900 shadow-lg relative">
          {pinnedParticipantId ? (
            (() => {
              ...
              if (pinned && pinned.videoEnabled && pinned.stream) {
                return (
                  <video
                    key={pinned.userId}
                    autoPlay
                ...
                return (
                  <div key={pinned.userId} className="flex items-center justify-center h-full text-white text-4xl font-bold rounded-3xl bg-blue-700">
                    {pinned.name}
                  </div>
                );
              }
