  ...
  const handleStartMeeting = (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      navigate(`/meeting/${meetingId}`, {
        state: { creatorName, meetingTitle, guests },
      });
    }, 1000);
  };
  ...
  return (
    <div className="min-h-screen bg-neutral-100 dark:bg-black">
      ...
      <form
        ...
        className="max-w-6xl mx-auto ml-20 pt-20 py-12 px-4 md:px-8 grid grid-cols-1 md:grid-cols-2  gap-8"
      >
        ...
        {/* RIGHT SECTION - Guest List & Creator */}
              ...
              <div className="flex space-x-2 mt-2">
                ...
                <Button
                  ...
                  onClick={() =>
                    navigator.share
                      ? navigator
                          .share({ title: 'Join my meeting', url: meetingUrl })
